    ...
    internal class TermAttribute : ValidationAttribute
    {
        public override bool IsValid(object? value)
        {
            if (value is string v)
            {
                ...
                if (regex.IsMatch(v))
                {
                    if (Constants.Constants.TimeUnitParam == Constants.Constants.TimeFrequency.Years
                    ...
                    else if (Constants.Constants.TimeUnitParam == Constants.Constants.TimeFrequency.Months
                    ...
                    else if (Constants.Constants.TimeUnitParam == Constants.Constants.TimeFrequency.Days
